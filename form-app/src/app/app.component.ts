...
public sentencias: string[] = ['Seleccionar ','Select', 'Insert', 'Update', 'Delete'];
public tiposJoin: string[] = ['Seleccionar ','Join', 'Left join', 'Inner Join', 'Right Join'];
 public sentencia: string = 'Seleccionar   ';
 public joinSeleccionado: string='';
...
public showJoin = false;
 ...
 ngOnInit() {
  this.selectForm = new FormGroup({
    ["Columnas" + this.selectIndice]: new FormControl("", [Validators.required]),
